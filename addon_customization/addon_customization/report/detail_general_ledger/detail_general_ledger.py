...
def get_gl_entries(filters):
	...
	gl_entries = frappe.db.sql(
		"""
		select
			name as gl_entry, posting_date, account, party_type, party, sub_customer,
...
def get_conditions(filters):
	...
	if filters.get("sub_customer"):
		conditions.append("sub_customer=%(sub_customer)s")
...
def get_result_as_list(data, filters):
	...
	for d in data:
		...
		# if d.get('party_type'):
		# 	if d["party_type"] == "Customer" and d["voucher_type"] != "Journal Entry" :
		# 		get_data = frappe.get_doc(d["voucher_type"], d["voucher_no"])
		# 		d["sub_customer"] = get_data.sub_customer
